...
```
- Hard gate: `min_trades = 10` — statistical significance on 12-month IS
...
| Low swing trade frequency (~20–40/yr) | Fitness min_trades=10 + IS Calmar≥0.5; Calmar×√trades respects low-frequency edge |
